...
public class URedisLibrary : ModuleRules
{
  public URedisLibrary(ReadOnlyTargetRules Target) : base(Target)
  {
    ...
    else if (Target.Platform == UnrealTargetPlatform.Win64)
    {
      ...
      PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "windows", "x64", libName));
      RuntimeDependencies.Add(Path.Combine(PluginDirectory, "Binaries", "Win64", dllName));
